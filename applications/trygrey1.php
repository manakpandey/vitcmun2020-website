...
<body bgcolor="#1c1c1c" onload="myFunction()">
...
<div>
<div class="popup" onclick="myFunction()">Council Preference<br>(Already selected according to your prior experience)
  <span class="popuptext" id="myPopup" style="color:white; padding-top:3px;">The countries with (A) have already been alloted</span>
</div>
</div>
</span>
                ...
                if ($result=mysqli_query($conn,$sql_disec))
                {
                    while ($row=mysqli_fetch_row($result))
                    {
                      if (in_array("$row[0]", $stack)){
                        ...
                        echo "<option value='$row[0]'>$row[0] (A)</option>";
