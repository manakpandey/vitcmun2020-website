...
echo "<script>document.getElementById('asd').innerHTML = 'Sorry, we could not find your allotment in our database, please check the filled details, or drop us a mail at <a href="mailto:delegateaffairs@vitcmun.in">delegateaffairs@vitcmun.in</a>';</script>";
