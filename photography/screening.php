...
<html>
    ...
    <head>
        ...
        <title>VITCMUN: Photography Applications</title>
    ...
    <body style="background-color: #000000">
	    <header>
		   <h1 align="center">VITCMUN'19: Photography Applications</h1>
        </header>
    <div align="center">
	...
	<div class="main-content">
		<form class="form-labels-on-top" method="POST" action="insert.php">
            ...
            <div align="left">
				<h4><b>Photography Experience</b></h4>&nbsp;
			...
			<div align="left">
				<h4><b>Sample photos (Kindly enter a drive link with 5 of your best work) </b></h4>&nbsp;
				<textarea class="textarea has-fixed-size" name="del_reason" rows="10" maxlength="5000" required></textarea>
			</div>&nbsp;
			<div align="left">
				<h4><b>Additional Comments (if Any)</b></h4>
				<br><textarea class="textarea" name="del_reason_1" rows="10" maxlength="5000"></textarea>
			</div>&nbsp;
			<!--div align="left">
